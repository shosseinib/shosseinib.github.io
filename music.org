...
- Deathwhite *Grey Everlasting* [[https://deathwhite.bandcamp.com/album/grey-everlasting?from=fanpub_nfnb_pr&utm_source=album_release&utm_medium=email&utm_content=fanpub_nfnb_pr&utm_campaign=deathwhite+album+grey-everlasting][bandcamp]]
  #+begin_quote
  A silent, heavy, and atmospheric album by an american band. I don't like the way they promoted their album by tagging other bands in the Bandcamp page, but it tells us: Amorphis, Katatonia (ew), Swallow the Sun, etc. Favorite track: *=10. Blood and Ruin=*.
  #+end_quote
** Progressive
